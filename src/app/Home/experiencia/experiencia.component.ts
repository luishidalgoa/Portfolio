  ...
  sections: { startDate: Date; endDate?: Date;puesto: string;company: string ;description: string; companyLogo?: string }[] = [
    {
      ...
      companyLogo: 'https://s3.minio.luishidalgoa.ddns-ip.net/portfolio/shared/deuser_logo.jpg'
    },
    {
      ...
      companyLogo: 'https://s3.minio.luishidalgoa.ddns-ip.net/portfolio/shared/atmira_logo.jpeg'
    },
    {
      ...
      companyLogo: 'https://s3.minio.luishidalgoa.ddns-ip.net/portfolio/shared/INPER.jpeg'
    },
  ]
