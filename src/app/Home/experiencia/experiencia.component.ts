  ...
  sections: { startDate: Date; endDate?: Date;puesto: string;company: string ;description: string; companyLogo?: string }[] = [
    {
      ...
      companyLogo: 'http://minio.luishidalgoa.ddns-ip.net:9001/api/v1/buckets/portfolio/objects/download?preview=true&prefix=shared%2Fdeuser_logo.jpg&version_id=null'
    },
    {
