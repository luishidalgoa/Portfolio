...
export class ProyectosComponent implements OnInit{
  cardsRendered: {title:string, description:string, articleUrl: string, imageUrl: string,tags:Technologies[],degree?:string}[] = [];
  cards: {title:string, description:string, articleUrl: string, imageUrl: string,tags:Technologies[],degree?:string}[] = [
